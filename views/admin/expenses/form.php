...
<div class="d-flex justify-content-between align-items-start mb-2 flex-wrap gap-2">
    <div>
        ...
        <p class="text-muted mb-0"><?= $e($isEdit ? $expense['description'] : $t('admin.expenses.subtitle')) ?></p>
    </div>
    <?= View::render('partials/back_button', ['href' => '/admin/expenses', 'label' => $t('admin.expenses.back_to_list')], null) ?>
</div>
