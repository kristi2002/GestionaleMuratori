...
use App\Controllers\Admin\LaborController;
...
$router->get('/2fa',          [TwoFactorController::class, 'index']);
...
$router->get('/admin/financials/labor', [LaborController::class, 'index']);
...
$router->get('/admin/interventions/recurring',              [RecurringInterventionController::class, 'index']);
$router->get('/admin/interventions/recurring/create',       [RecurringInterventionController::class, 'create']);
$router->post('/admin/interventions/recurring',             [RecurringInterventionController::class, 'store']);
$router->get('/admin/interventions/recurring/{id}/edit',    [RecurringInterventionController::class, 'edit']);
$router->post('/admin/interventions/recurring/{id}',        [RecurringInterventionController::class, 'update']);
$router->post('/admin/interventions/recurring/{id}/toggle', [RecurringInterventionController::class, 'toggleActive']);
$router->post('/admin/interventions/recurring/{id}/delete', [RecurringInterventionController::class, 'delete']);
...
$router->get('/admin/users/{id}/badge',     [BadgeController::class, 'pdf']);
